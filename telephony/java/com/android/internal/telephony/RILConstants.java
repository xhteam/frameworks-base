...
*/
    ...
    int RIL_REQUEST_PTT_QUERY_AVAILABLE_GROUPS = 109;
    int RIL_REQUEST_PTT_GROUP_SETUP  = 110;
    int RIL_REQUEST_PTT_GROUP_RELEASE = 111;
    int RIL_REQUEST_PTT_CALL_DIAL = 112;
    int RIL_REQUEST_PTT_CALL_HANGUP = 113;
    int RIL_REQUEST_PTT_CURRENT_GROUP_SCANLIST_UPDATE = 114;
    int RIL_REQUEST_PTT_QUERY_BLOCKED_INDICATOR = 115;
    int RIL_REQUEST_PTT_DEVICE_INFO = 116;
    int RIL_REQUEST_PTT_QUERY_BIZ_STATE = 117;
	/**************written by johnny.gan*********************/	
//    int RIL_REQUEST_GET_INTERCOM_GROUP_LIST = 109;
    ...
    int RIL_UNSOL_PTT_CALL_INDICATOR =  (1035 + 1);
    int RIL_UNSOL_PTT_GROUP_RELEASE = (1035 + 2);
    int RIL_UNSOL_PTT_NOTIFICATION_CALL = (1035 + 3);
    int RIL_UNSOL_PTT_CALL_CONNECT = (1035 + 4);
    int RIL_UNSOL_PTT_CALL_HANGUP =  (1035 + 5);
    int RIL_UNSOL_PTT_OUTGOING_CALL_PROGRESS =  (1035 + 6);
    int RIL_UNSOL_PTT_BLOCKED_INDICATOR = (1035 + 7);
    int RIL_UNSOL_PTT_AVAILABLE_GROUP_CHANGED = (1035 + 8);
    int RIL_UNSOL_PTT_NOTIFICATION_DIAL = (1035 + 9);
    int RIL_UNSOL_PTT_CURRENT_GROUP_ACTIVE_LIST = (1035 + 10);
    int RIL_UNSOL_PTT_DEVICE_INFO = (1035 + 11);
    int RIL_UNSOL_PTT_GROUP_OWNER = (1035 + 12);
    int RIL_UNSOL_PTT_TRUNKING_MODE = (1035 + 13);
    int RIL_UNSOL_PTT_NOTIFICATION_JOIN_GROUP = (1035 + 14);
    int RIL_UNSOL_PTT_BIZ_INFO = (1035 + 15);
    int RIL_UNSOL_PTT_NETWORK_VERSION = (1035 + 16);
}
